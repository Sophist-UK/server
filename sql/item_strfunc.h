...
public:
  ...
  { return "database()"_Lex_ident_routine; }
  Item *get_copy(THD *thd) override
...
public:
  ...
  const Lex_ident_routine fully_qualified_func_name() const override
  { return "SQLERRM"_Lex_ident_routine; }
  void print(String *str, enum_query_type query_type) override
  {
...
public:
  ...
  const Lex_ident_routine fully_qualified_func_name() const override
  { return "user()"_Lex_ident_routine; }
...
public:
  ...
  const Lex_ident_routine fully_qualified_func_name() const override
  { return "current_user()"_Lex_ident_routine; }
  bool check_vcol_func_processor(void *arg) override
  {
    context= 0;
    return mark_unsupported_function(fully_qualified_func_name().str, arg,
...
public:
  ...
  const Lex_ident_routine fully_qualified_func_name() const override
  { return "current_role()"_Lex_ident_routine; }
  String *val_str(String *) override
  {
    DBUG_ASSERT(fixed());
