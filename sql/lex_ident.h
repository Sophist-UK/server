...
#endif
  bool check_table_name(bool check_for_path_chars) const;
};
...
static inline constexpr
Lex_ident_routine operator"" _Lex_ident_routine(const char *str, size_t length)
{
  return Lex_ident_routine(str, length);
}
